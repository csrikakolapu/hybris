 ...
 * --- Generated at Mar 17, 2017 8:21:11 PM                     ---
 * ----------------------------------------------------------------
 */
...
import de.hybris.merchandise.core.jalo.actions.CustomCancelOrderAction;
...
public abstract class GeneratedMerchandiseCoreManager extends Extension
{
	...
	public CustomCancelOrderAction createCustomCancelOrderAction(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( MerchandiseCoreConstants.TC.CUSTOMCANCELORDERACTION );
			return (CustomCancelOrderAction)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating CustomCancelOrderAction : "+e.getMessage(), 0 );
		}
	}
	
	public CustomCancelOrderAction createCustomCancelOrderAction(final Map attributeValues)
	{
		return createCustomCancelOrderAction( getSession().getSessionContext(), attributeValues );
	}
