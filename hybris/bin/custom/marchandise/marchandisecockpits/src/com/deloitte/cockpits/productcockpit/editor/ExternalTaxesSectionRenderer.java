...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("marchandisecockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("marchandisecockpits.product.externalTaxes"));
