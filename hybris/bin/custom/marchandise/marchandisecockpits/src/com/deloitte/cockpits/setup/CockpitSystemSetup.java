...
import com.deloitte.cockpits.constants.MarchandiseCockpitsConstants;
 ...
 */
@SystemSetup(extension = MarchandiseCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MarchandiseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MarchandiseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MarchandiseCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/marchandisecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
