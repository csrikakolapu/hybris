...
import com.deloitte.test.constants.MarchandiseTestConstants;
 ...
 */
@SystemSetup(extension = MarchandiseTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/marchandisetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/marchandisetest/import/reviews.impex");
			...
			importImpexFile(context, "/marchandisetest/import/cstickets.impex");
		}
	}
}
