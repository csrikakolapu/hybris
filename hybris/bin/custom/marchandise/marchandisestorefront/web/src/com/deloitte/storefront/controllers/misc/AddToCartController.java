...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "marchandisestorefront.storefront.minicart.shownProductCount";
	...
	public final String addQuickOrderToCart(@RequestBody final AddToCartOrderForm form, final Model model)
	{
		...
		final int maxQuickOrderEntries = Config.getInt("marchandisestorefront.quick.order.rows.max", 25);
