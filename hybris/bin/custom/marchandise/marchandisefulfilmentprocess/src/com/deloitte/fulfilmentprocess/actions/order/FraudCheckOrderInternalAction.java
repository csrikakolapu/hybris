...
public class FraudCheckOrderInternalAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)//NOPMD
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(MarchandiseFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimit"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(MarchandiseFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreTolerance"));
