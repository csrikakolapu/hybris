 ...
 * --- Generated at Feb 21, 2017 7:18:11 AM                     ---
 * ----------------------------------------------------------------
 */
...
/**
 * Generated class for type <code>MarchandiseFulfilmentProcessManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedMarchandiseFulfilmentProcessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, MarchandiseFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, MarchandiseFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return MarchandiseFulfilmentProcessConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, MarchandiseFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, MarchandiseFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, MarchandiseFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, MarchandiseFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
