...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/marchandisefulfilmentprocess/test/marchandisefulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/marchandisefulfilmentprocess/test/marchandisefulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/marchandisefulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/marchandisefulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/marchandisefulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/marchandisefulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/marchandisefulfilmentprocess/test/marchandisefulfilmentprocess-spring-testcleanup.xml"));
