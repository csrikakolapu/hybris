...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception //NOPMD
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/marchandisefulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/marchandisefulfilmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/marchandisefulfilmentprocess/test/process/consignment-process.xml");
